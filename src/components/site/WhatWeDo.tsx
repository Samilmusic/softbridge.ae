...
const ITEMS = [
  { icon: Briefcase, title: "Business Formation", text: "Activity, jurisdiction, and license structure planned around your real business model." },
  { icon: IdCard, title: "Residency & Relocation", text: "Investor visa, Emirates ID, medical, and family residency handled end-to-end." },
  { icon: Landmark, title: "Banking Preparation", text: "Profile readiness, KYC, source of funds and bank introductions aligned to your activity." },
  { icon: ShieldCheck, title: "AML & Compliance", text: "AML/CFT readiness, ESR, UBO, and ongoing regulatory documentation kept in order." },
  { icon: Globe, title: "Website Development", text: "Conversion-focused websites and landing pages built on modern, fast frameworks." },
  { icon: Megaphone, title: "Digital Advertising", text: "Google and Meta campaigns engineered for measurable, qualified pipeline." },
  { icon: Headphones, title: "Operational Support", text: "Renewals, document changes, government coordination and day-to-day operations." },
  { icon: TrendingUp, title: "Business Growth Systems", text: "CRM, automations, and reporting that turn operations into a growth engine." },
];
