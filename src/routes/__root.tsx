...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Soft Bridge FZE LLC — Bridge to Your Success" },
      { property: "og:description", content: "UAE business setup, residency, banking, compliance and digital growth — built for long-term success." },
